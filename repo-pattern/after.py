...
# No implementation details about how this is stored (database, file, etc.)
@dataclass
class Post:
    title: str
    content: str
...
# Standard CRUD operations repository without details (how we access/modify data)
...
# Concrete implementation of how are Posts stored in a SQL database (how we store the data)
# Could be more generic like SQLRepository like SQLAlchemy
